...
/**
 * 异步对象代理实现类
 * Created by wkm on 2016-03-16.
 */
public class AsyncObjectProxyImpl<T> implements InvocationHandler, IAsyncObjectProxy {
    private static final Logger LOGGER = LoggerFactory.getLogger(AsyncObjectProxyImpl.class);
